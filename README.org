...
#+bibliography: computational_semantics.bib
...
* Overview
  ...
  language, as we rely on it as a metalanguage to state our theories.
...
* Schedule
  ...
  | November 15   | Abstract interfaces: monads and /in situ/ composition                      |                        |           |
  | November 20   | Probabilistic programming with finite distributions                      |                        |           |
  | November 27   | Probabilistic semantics via `Reader`                                     |                        |           |
  | November 29   | Hybrid probabilistic/FOL systems                                         |                        |           |
  | December 4    | Expanding the probabilistic interface                                    |                        |           |
  | December 6    | Two levels of probabilistic involvement                                  |                        |           |
  | December 11   | Probabilistic programs as Bayesian models: part 1                        |                        |           |
  | December 13   | Probabilistic programs as Bayesian models: part 2                        |                        |           |
...
$ brew install haskell-stack
  ...
  Another option for macOS users is to install [[https://www.haskell.org/ghcup/][~GHCP~]] by following the
